...
router.route('/productos').get(isAuthenticatedUser,authorizeRoles("admin","user"),getProducts); //creamos la ruta, get es para obtener, post es para crear, route es para crear una ruta, getProducts es el metodo que vamos a ejecutar, createProduct es el metodo que vamos a ejecutar
